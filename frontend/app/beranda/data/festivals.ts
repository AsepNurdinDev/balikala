...
export const FESTIVALS: Festival[] = [
  {
    ...
    name: "Nyepi",
    date: "18 Maret 2026",
    formattedDate: "Rabu, 18 Maret 2026",
    nextDate: "2026-03-18T06:00:00",
  ...
  },
  {
    ...
    name: "Pengrupukan",
    date: "17 Maret 2026",
    formattedDate: "Selasa, 17 Maret 2026",
    nextDate: "2026-03-17T18:00:00",
    category: "Sasih (Tawur Kesanga)",
    shortDesc: "Malam Pengusiran Kekuatan Negatif dengan Pawai Ogoh-Ogoh yang Semarak.",
    description: "Pengrupukan dilaksanakan sehari sebelum Nyepi (Malam Tilem Kesanga). Ritual ini bertujuan untuk mengusir Bhuta Kala (kekuatan negatif) dari pekarangan rumah, desa, dan lingkungan sekitar agar keheningan Nyepi esok hari berjalan damai. Pada malam hari, warga mengarak Ogoh-ogoh (patung raksasa simbol Bhuta Kala) keliling desa dengan obor menyala dan gamelan Baleganjur yang dinamis, kemudian ogoh-ogoh dibakar sebagai simbol pemusnahan kekuatan jahat.",
    rituals: [
      "Mebuu-buu (menyebar nasi tawur, memukul kentongan, dan menyalakan obor di rumah)",
      "Somya Bhuta Kala (persembahyangan menetralisir energi negatif menjadi positif)",
      "Pawai Ogoh-ogoh (parade patung raksasa ekspresi seni pemuda desa)",
      "Pralina Ogoh-ogoh (pembakaran ogoh-ogoh di kuburan desa adat/setra)"
    ],
    color: "#A61E2D",
    gradient: "from-[#A61E2D] via-rose-950 to-stone-950",
    illustrationType: 'pengrupukan'
  },
  {
    id: "galungan",
    name: "Galungan",
    date: "17 Juni 2026",
    formattedDate: "Rabu, 1 Juni 2026",
    nextDate: "2026-06-17T08:00:00",
  ...
  },
  {
    ...
    formattedDate: "Rabu, 26 Agustus 2026",
    nextDate: "2026-08-26T08:00:00",
